...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-configuraciones-de-vista"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-configuraciones-de-vista"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-configuraciones-de-vista \
    KIRLET_TECHNICAL_ID=subject-configuraciones-de-vista \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
